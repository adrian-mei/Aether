...
export const LandscapeWarning = () => {
  return (
    <div className="fixed inset-0 z-50 hidden landscape:flex md:landscape:hidden flex-col items-center justify-center bg-black/95 text-center p-6 touch-none">
